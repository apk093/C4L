...
<div class="clear"></div>		
		...
		?>
						...
						<span style="font-size:14px;font-weight:400">
							<i><strong><?php echo $M_PERSONAL_INFORMATION;?></strong></i>
						</span>
						...
						<br><br><br>
						<span style="font-size:14px;font-weight:400">
							<i><strong><?php echo $M_WORK_HISTORY;?></strong></i>
						</span>
						<br><br>
						...
						<span style="font-size:14px;font-weight:400">
							<i><strong><?php echo $M_SKILLS;?></strong></i>
						</span>
					  ...
					  ?>
						...
						<span style="font-size:14px;font-weight:400">
							<i><strong><?php echo $M_EDUCATION;?></strong></i>
						</span>
						<br><br>
