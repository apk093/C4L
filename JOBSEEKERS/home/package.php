...
$arrPackage = $database->DataArray("packages","id=".$package);
...
<?php
$arrUser = $database->DataArray("vendors","username='$AuthUserName'");
$arrPackage = $database->DataArray("packages","id=".$arrUser["plan"]);
