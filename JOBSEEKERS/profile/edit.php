...
foreach($arrUserFields as $arrUserField)
{
	...
	{
			$strSpecialHiddenFieldsToAdd.= "<input ".(isset($_REQUEST["select-width"])?"style=\"width:".$_REQUEST["select-width"]."px !important\"":"")." value=\"".(isset($arrPropFields[$arrUserField[0]])?$arrPropFields[$arrUserField[0]]:"")."\" type=text name=\"pfield".$iFCounter."\">";
	}
