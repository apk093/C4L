...
<div class="page-wrap">
	...
	if(isset($_POST["ProceedSend"])&&$_POST["ProceedSend"] != "")
	{
		...
		else
		{
			...
			$job_category=explode("@",$_POST["field_category"]);
			$job_location=explode("@",$_POST["field_location"]);
			...
			$database->SQLInsert
				...
				$website->send_mail($_REQUEST["email"], $M_EMAIL_ALERT_ACTIVATION, $message);
	...
	<script>
		...
		<form action="index.php" style="margin-bottom:0px;margin-top:10px" method=post name="main" id="main" onsubmit="return SubmitForm2(this)">	
