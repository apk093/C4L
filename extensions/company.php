...
$total_jobs_number=$database->SQLCount("jobs","WHERE employer='".$company["username"]."' AND status=1 AND active='YES'");
		  ...
		  <br/>
            <div class="tab-pane active" id="tab-details">
				...
				<div class="row">
					...
					if($company["show_information"]==1)
					{
						...
						{
						?>
						<?php echo $M_WEBSITE;?>: <b><a class="underline-link" rel="nofollow" title="<?php echo $company["website"];?>" href="<?php if(strpos($company["website"], "https://")===false&&strpos($company["website"], "http://")===false) echo "http://"; echo $company["website"];?>" target="_blank"><?php echo $company["website"];?></a></b>
				...
				<br/><br/>
				<?php	
					$latest_jobs=$database->DataTable("jobs","WHERE employer='".$company["username"]."' AND status=1 AND active='YES' ORDER BY id DESC LIMIT 0,100");
					$i_latest_counter=0;
            ...
            <div class="tab-pane" id="tab-contact">
				...
				?>
					...
					<script type="text/javascript" src="https://maps.google.com/maps/api/js?key=AIzaSyADZ822boICn2KIwvqDSykYGampruC_oOc"></script> 
