		...
		<input type="hidden" name="advanced" id="advanced_s" value="0">
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<?php echo $M_FROM;?> 
					<input type="number" step="0.01" name="salary_from" class="form-control" style="width:140px !important;display:inline" placeholder="">
					&nbsp; 
					<?php echo $M_TO;?> 
					<input type="number" step="0.01" name="salary_to" class="form-control" style="width:140px !important;display:inline" placeholder="">
					&nbsp;
					<?php echo $M_PER;?> 
					<select name="salary_type" class="form-control" style="width:100px !important;display:inline">
						<option value="1"><?php echo $M_HOUR;?></option>
						<option value="2"><?php echo $M_WEEK;?></option>
						<option value="3" selected><?php echo $M_MONTH;?></option>
						<option value="4"><?php echo $M_YEAR;?></option>
			
					</select> 
					 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="checkbox" name="bonuses" value="1">
					<?php echo $M_INCLUDING_BONUSES;?>
				</div>
