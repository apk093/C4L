...
function CallBack()
{
	...
	<div class="col-md-3 welcome-left-block">
		...
		<?php
			...
			$new_messages = $database->SQLCount("user_messages","WHERE user_to='".$AuthUserName."' AND date>=".$last_login["max_date"]);
			...
			?>
				...
				<span class="home-warning-text">
					<a class="underline-link" href="index.php?category=home&action=received"><?php echo $new_messages;?> <?php echo $M_NEW_MESSAGES;?></a>
				</span>
			<?php
			}
			else
			...
			if(sizeof($p_items)==1) continue;
				...
				<div class="col-md-4 col-sm-6 col-xs-12 t-padding" id="box-<?php echo $i;?>">
					...
					if($b_pos===false)
					{
						...
						if(isset($oLinkTexts[$t_key])&&$t_key!="home")
						{
