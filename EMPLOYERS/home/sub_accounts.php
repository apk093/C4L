...
<div class="pull-right">
	<a href="index.php?category=<?php echo $category;?>&folder=<?php echo $action;?>&page=perm" style="text-transform:uppercase;text-decoration:underline"><?php echo $M_CLICK_SUB_ACCOUNTS;?></a>
</div>			  
