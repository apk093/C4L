...
if($listing["employer"]!=$AuthUserName) die("");
	...
	{	
		?>
			...
			?>
				...
				<input type="hidden" name="item_name" value="<?php echo "Payment for featured job #".$id." on ".$DOMAIN_NAME;?> ">
				<input type="hidden" name="item_number" value="<?php echo $id;?>">
				<input type="hidden" name="custom" value="<?php echo $id;?>">
				<input type="hidden" name="amount" value="<?php echo number_format($website->GetParam("PRICE_FEATURED_JOB"), 2, '.', '');?>">
				<input type="hidden" name="notify_url" value="<?php echo "http://".$DOMAIN_NAME."/ipn_job_featured.php";?>">
			...
			{
				echo "<br/><hr/><br/>";
				echo "<img src='images/bank-transfer.png' align='left' style='margin-right:30px;'/><h4>".$M_AMOUNT.": <strong>".$website->GetParam("CURRENCY").number_format($website->GetParam("PRICE_FEATURED_JOB"), 2, '.', '')."</strong><br/><br/><br/>".nl2br(stripslashes($website->GetParam("BANK_ACCOUNT")))."</h4>";
			}
			?>
