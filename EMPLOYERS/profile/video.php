...
<br>
	...
	<?php echo $M_VIDEO_ID_URL;?>: <input type="text" name="video_file" value="<?php if(isset($_POST["video_file_id"])) echo $_POST["video_file_id"];else if(!is_numeric($arrUser["video_id"])) echo $arrUser["video_id"];?>" size="40"/>
	<br><br><br>
