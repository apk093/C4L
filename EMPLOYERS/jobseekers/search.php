...
<?php
if(!isset($_REQUEST["ProceedSearch"]))
{
?>
	...
	<div class="container">
		...
		<div class="col-md-2" style="margin:0 !important">
			<h4 class="black-text"><?php echo $M_JOB_PREFERENCES;?></h4>
			...
			<br/>
					...
					<?php 
						echo $M_EXPECTED_UP_TO;
					?>:	
		
				
					<input type="text" size="20" name="expected_salary" class="form-control">
		...
		<br><br>
			...
			<div class="col-md-4" style="border-left:3px solid #7d3ae1;padding-left:40px;padding-bottom:5px">
				<?php 
		...
		<div class="col-md-10">
			...
			<input type="submit" class="btn btn-primary pull-right" style="min-width:150px" value=" <?php echo $SEARCH;?> ">
		</div>
...
else
{
	...
	if(get_param("experience")!=""&&get_param("experience")!="-1")
	{
		$strAddQuery .= " AND experience=".get_param("experience");
	}
	
	
	if(get_param("expected_salary")!="")
	{

		$strAddQuery .= " AND expected_salary<=".preg_replace("/[^0-9]/","",get_param("expected_salary"));
