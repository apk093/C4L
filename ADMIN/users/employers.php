...
if($website->GetParam("CHARGE_TYPE")==1)
{
	...
	(
		"employers",
		array("EditNote","show_images","username","company","phone","show_subscription","ShowPictureEmployer","date","ShowActive"),
		array($MODIFY,$M_LOGO,$M_EMAIL,$M_COMPANY,$M_PHONE,$M_SUBSCRIPTION,$M_LOGO,$M_DATE,$ACTIVE),
		"100%",
		"",
		$EFFACER,
		"id",
...
else
{
	...
	(
		"employers",
		array("EditNote","show_images","username","company","phone","credits","ShowPictureEmployer","date","ShowActive"),
		array($MODIFY,$M_LOGO,$M_EMAIL,$M_COMPANY,$M_PHONE,$M_CREDITS,$M_LOGO,$M_DATE,$ACTIVE),
		"100%",
		"",
		$EFFACER,
		"id",
