...
if(isset($_REQUEST["ProceedSend"])&&isset($_REQUEST["newsletter_id"]))
{
	...
	if($_REQUEST["recepients"] == 8)
	{
		
		
		
		$arrMailingList2 = $database->DataTable
		("jobseekers",
			"WHERE 
			industry_sector LIKE '%\"".$_POST["jobseekers_category"]."-%\"%'
			OR
			industry_sector LIKE '%\"".$_POST["jobseekers_category"]."\"%'
			"
		);	
	...
	{	
		$bSuccess = $website->send_mail($strEmail, $strMessageSubject,$strMessageBody);
...
<input class="m-radio" type=radio name=recepients value=1 checked/>
...
<input class="m-radio" type=radio name=recepients value=2/>
...
<input class="m-radio" type=radio name=recepients value=3/>
...
<input class="m-radio" type=radio name=recepients value=4/>
...
<input class="m-radio" type="radio" name="recepients" value="8"/>

Job seekers interested in Category:

<select name="jobseekers_category" style="width:260px" id="jobseekers_category" >
...
<input class="m-radio" type=radio name=recepients value=5/>
...
<input class="m-radio" type=radio name=recepients value=6/>
...
<input class="m-radio" type=radio name=recepients value=7 > 
