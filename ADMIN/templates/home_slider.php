...
<input type="radio" name="slider_type" value="2" <?php if($slider_type==2) echo "checked";?> style="position:relative;top:8px"/>
...
<input type="radio" name="slider_type" value="1" <?php if($slider_type==1) echo "checked";?> style="position:relative;top:8px;margin-left:15px"/>
