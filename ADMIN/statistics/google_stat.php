...
(
		"statistics",
		array("timestamp","GoogleQuery"),
		array($DATE_MESSAGE,$QUERY),
		750,
		($strWhereQuery==""?"WHERE referer LIKE '%google%'":$strWhereQuery." AND referer LIKE '%google%'"),
		"",
		"",
		"index.php"
);
