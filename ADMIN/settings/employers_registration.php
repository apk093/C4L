		...
		{		
			...
			if(!$website->GetParam("NEW_USERS_EMAIL_VALIDATION_ON_SIGNUP"))
			{
					...
					("employers",
						...
						array("date","employer_fields","active","username","password","company","contact_person","company_description","address","phone","website","newsletter","credits","language","agency"),
						array(time(),serialize($arrPValues),"1",$user_email,$_POST["password"],$_POST["company"],$_POST["contact_person"],$_POST["company_description"],$_POST["address"],$_POST["phone"],$_POST["website"],(isset($_POST["newsletter"])?"1":"0"),$website->GetParam("FREE_CREDITS_NEW_USERS"),$website->lang,$_POST["agency"])
					
					);
					
					if($website->params[104]==1)
					{
						$website->send_mail($user_email, $website->params[105], $website->params[106]);
					}
			...
			else
			{
					...
					(
						"employers",
						array("date","employer_fields","code","username","password","company","contact_person","company_description","address","phone","website","newsletter","credits","language","agency"),
						array(time(),serialize($arrPValues),$code,$user_email,$_POST["password"],$_POST["company"],$_POST["contact_person"],$_POST["company_description"],$_POST["address"],$_POST["phone"],$_POST["website"],$_POST["newsletter"],$website->GetParam("FREE_CREDITS_NEW_USERS"),$website->lang,$_POST["agency"])
					);
					...
					$website->send_mail($user_email, "".$website->params[815]."", $message);
...
<br>
		...
		<ol>
			<li>
				...
				<div class="div_label">
					<?php echo $M_RECRUITER_OR_AGENCY;?>
				</div>
				<div class="div_field">
					<input type="radio" name="agency" class="div_radio" value="0" checked/> 
					<?php echo $M_RECRUITER;?>
					<br/>
					<input type="radio" name="agency" class="div_radio" value="1"/> 
					<?php echo $M_JOB_AGENCY;?>
				</div>
		...
		<li>
			...
			<li>
				...
				<?php echo $M_PHONE;?>:
					...
					<input type="text" required name="phone" id="phone" value="<?php echo get_param("phone");?>">
			</li>
			<li>
				<label>
					<?php echo $M_WEBSITE;?>:
					...
					<input type="text" required name="website" id="website" value="<?php echo get_param("website");?>">
			</li>
